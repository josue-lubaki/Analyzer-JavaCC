    ...
    if (args.length == 0) {
      while(!exit) {
        do {
                ...
                System.out.print(WHITE_BOLD_BRIGHT + "\u005ct 3. " + RESET + "Voir le resultat sauvegarde dans le dossier " + directoryResultat);
                if(resultDisponible)
                        System.out.println(GREEN_BOLD + " (ALLOWED)" + RESET);
                else
                        System.out.println(RED + " (NOT ALLOWED)" + RESET);
              ...
              if(indice == 0) {
                  ...
                  resultDisponible = true;
                        ...
                        System.out.println(WHITE_BOLD_BRIGHT + "COMPUTER " + RESET + ": Sorry, Les resultats ne sont pas encore pr\u00c3\u00aat");
        ...
        System.out.println("\u005ct\u005ctVoici la liste des fichiers contanent le resultat d'analyse");
                        System.out.println(WHITE_BOLD + "\u005ct\u005ctNote : le format est \u005c"NomClasse-Annee-Mois-Jour_Heure-Minutes.txt\u005c"" + RESET);
                      ...
                      } while(String.valueOf(fChoice).matches("[0-9]") && Integer.parseInt(fChoiceString) <= fileListResultat.size());
    ...
    while (true) {
      ...
      case PUBLIC:
        jj_consume_token(PUBLIC);
              modifiers |= JavaModifierSet.PUBLIC;
        break;
      case STATIC:
        jj_consume_token(STATIC);
              modifiers |= JavaModifierSet.STATIC;
        break;
      case PROTECTED:
        jj_consume_token(PROTECTED);
                 modifiers |= JavaModifierSet.PROTECTED;
        break;
      case PRIVATE:
        jj_consume_token(PRIVATE);
               modifiers |= JavaModifierSet.PRIVATE;
        break;
      case FINAL:
        jj_consume_token(FINAL);
             modifiers |= JavaModifierSet.FINAL;
        break;
      case ABSTRACT:
        jj_consume_token(ABSTRACT);
                modifiers |= JavaModifierSet.ABSTRACT;
        break;
      case SYNCHRONIZED:
        jj_consume_token(SYNCHRONIZED);
                    modifiers |= JavaModifierSet.SYNCHRONIZED;
        break;
      case NATIVE:
        jj_consume_token(NATIVE);
              modifiers |= JavaModifierSet.NATIVE;
        break;
      case TRANSIENT:
        jj_consume_token(TRANSIENT);
                 modifiers |= JavaModifierSet.TRANSIENT;
        break;
      case VOLATILE:
        jj_consume_token(VOLATILE);
                modifiers |= JavaModifierSet.VOLATILE;
        break;
      case STRICTFP:
        jj_consume_token(STRICTFP);
                modifiers |= JavaModifierSet.STRICTFP;
        break;
      case AT:
        Annotation();
        break;
...
//}
  final public List<String> ExtendsList(boolean isInterface) throws ParseException {
   List<String> extendsList = new ArrayList<String>();
...
}
{
  ...
  final public List<String> ImplementsList(boolean isInterface) throws ParseException {
        List<String> implementsList = new ArrayList<String>();
...
}
{
  ...
  final public String VariableDeclaratorId() throws ParseException {
    ...
    {if (true) return nameToken.toString();}
    throw new Error("Missing return statement in function");
  }
...
}
{
  ...
  final public JavaMethod MethodDeclarator() throws ParseException {
        Token nameToken;
...
}
{
  ...
  final public List<JavaAttribute> FormalParameters() throws ParseException {
...
}
{
  ...
  final public JavaAttribute FormalParameter() throws ParseException {
        int modifiers;
        String type = "";
        String name = "";
    // danson, added
    ...
    name = VariableDeclaratorId();
    {if (true) return new JavaAttribute(name, type, modifiers);}
    throw new Error("Missing return statement in function");
  }
...
}
{
  ...
  Token nameToken;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case BOOLEAN:
      nameToken = jj_consume_token(BOOLEAN);
      break;
    case CHAR:
      nameToken = jj_consume_token(CHAR);
      break;
    case BYTE:
      nameToken = jj_consume_token(BYTE);
      break;
    case SHORT:
      nameToken = jj_consume_token(SHORT);
      break;
    case INT:
      nameToken = jj_consume_token(INT);
      break;
    case LONG:
      nameToken = jj_consume_token(LONG);
      break;
    case FLOAT:
      nameToken = jj_consume_token(FLOAT);
      break;
    case DOUBLE:
      nameToken = jj_consume_token(DOUBLE);
      break;
    default:
      jj_la1[58] = jj_gen;
      jj_consume_token(-1);
...
}
{
  ...
  final public String ResultType() throws ParseException {
    ...
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case VOID:
      nameToken = jj_consume_token(VOID);
    {if (true) return nameToken.toString();}
      break;
    case BOOLEAN:
    case BYTE:
...
}
{
  ...
  final public String PrimarySuffix() throws ParseException {
    ...
    {if (true) return nameToken == null ? "" : String.format(".%s", nameToken.toString());}
    throw new Error("Missing return statement in function");
  }
...
/* Annotation Types. */
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x0,0x90202000,0x0,0x0,0x0,0x0,0x80002000,0x10000000,0x90202000,0x200000,0x0,0x20000000,0x0,0x0,0x0,0x0,0x0,0x9432a000,0x0,0x0,0x0,0x0,0x0,0x20000000,0x0,0x9432a000,0x10200000,0x4128000,0x9432a000,0x0,0x0,0x0,0x44128000,0x44128000,0x0,0x0,0x0,0x0,0x0,0x0,0x8412a000,0x80000000,0x80000000,0x0,0x0,0x0,0xc6b3e000,0x0,0x0,0x0,0x0,0x4128000,0x4128000,0x0,0x0,0x20000000,0x4128000,0x20000000,0x4128000,0x4128000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x44128000,0x0,0x0,0x44128000,0x40000000,0x0,0x0,0x0,0x0,0x0,0x40000000,0x0,0x0,0x0,0x0,0x40000000,0x40000000,0x44128000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x4693c000,0x0,0xc6b3e000,0x200000,0x0,0x0,0x0,0x44128000,0x1040000,0xc6b3e000,0x1040000,0x8000000,0x80000000,0xc412a000,0x44128000,0x44128000,0xc412a000,0x80000000,0x44128000,0x0,0x0,0x0,0x44128000,0x0,0x0,0x80000,0x0,0x0,0x0,0x0,0x0,0x44128000,0x0,0x44128000,0x9432a000,0x1000000,0x10000000,0x4128000,0x9432a000,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x40,0x11338a00,0x0,0x0,0x100000,0x0,0x11338800,0x0,0x11338a00,0x200,0x0,0x0,0x20,0x0,0x0,0x20,0x0,0x913b8f02,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x913b8f02,0x200,0x80080502,0x913b8f02,0x0,0x0,0x0,0xa2483502,0xa2483502,0x0,0x0,0x8000000,0x0,0x0,0x0,0x113b8d02,0x0,0x0,0x0,0x0,0x8000000,0xf7ffbf16,0x0,0x0,0x2400000,0x100000,0x80502,0x80502,0x0,0x0,0x400000,0x80502,0x400000,0x80502,0x80080502,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x80,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xa2483502,0x0,0x0,0xa2483502,0x22403000,0x0,0x0,0x0,0x0,0x0,0x20002000,0x400000,0x1000,0x0,0x0,0x20002000,0x20000000,0xa2483502,0x0,0x0,0x0,0x0,0x1000,0x0,0x0,0xe7cc3516,0x0,0xf7ffbf16,0x200,0x0,0x0,0x0,0xa2483502,0x0,0xf7ffbf16,0x0,0x0,0x0,0xb37bbd02,0xa2483502,0xa2483502,0xb37bbd02,0x0,0xa2483502,0x0,0x0,0x0,0xa2483502,0x0,0x0,0x0,0x0,0x1,0x0,0x0,0x0,0xa2483502,0x0,0xa2483502,0x113b8f02,0x0,0x0,0x80502,0x113b8f02,};
   }
   private static void jj_la1_init_2() {
      jj_la1_2 = new int[] {0x0,0x900001,0x0,0x0,0x0,0x400000,0x800001,0x800000,0x900001,0x0,0x2000000,0x0,0x0,0x200000,0x200000,0x0,0x200000,0x2910801,0x100000,0x4000,0x10000,0x800,0x200000,0x0,0x0,0x2910801,0x0,0x2800800,0x2900801,0x200000,0x1000000,0x40000,0xc014e84,0xc014e84,0x200000,0x2000000,0x0,0x110000,0x40000,0x200000,0x800801,0x800000,0x800000,0x0,0x2000000,0x0,0x914e87,0x800,0x2000000,0x0,0x0,0x0,0x800,0x200000,0x2000000,0x0,0x10000800,0x0,0x0,0x800,0x200000,0x1000000,0x10000000,0x0,0x0,0x0,0x0,0x0,0x40000000,0x40000000,0x0,0x82000000,0x82000000,0x0,0x0,0x0,0x0,0x0,0x0,0xc004e84,0xc000000,0xc000000,0x4e84,0xc004e84,0x4000,0x0,0x0,0x4000,0x800,0x684,0x0,0x4000,0x800,0x444000,0x684,0x0,0xc004e84,0x200000,0x2000000,0x10000,0x44000,0x0,0x40000,0x40000,0x114e86,0x20000000,0x914e87,0x0,0x200000,0x1000000,0x1000000,0x4e84,0x0,0x914e87,0x0,0x0,0x0,0x804e85,0xc004e84,0x4e84,0x904e85,0x0,0x4e84,0x200000,0x800,0x800,0xc004e84,0x100000,0x4000,0x0,0x800,0x0,0x800000,0x800,0x200000,0xc014e84,0x200000,0xc814e84,0x900801,0x0,0x0,0x800,0x900801,};
   }
   private static void jj_la1_init_3() {
      jj_la1_3 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x400,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xf0,0xf0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x4000000,0x0,0x0,0x30,0x0,0x10000000,0x0,0x0,0x0,0x0,0x0,0x10000000,0x0,0x0,0x0,0x0,0x0,0x0,0x3ff8000,0x0,0x4,0x8,0x800,0x1000,0x400,0x2,0x2,0x0,0x80000001,0x80000001,0x4000,0xc0,0xc0,0x2300,0x2300,0xc0,0xf0,0x0,0x0,0x0,0x0,0x0,0x30,0x30,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xf0,0x0,0x10000000,0x0,0x0,0x0,0x0,0x0,0x30,0x0,0x30,0x0,0x0,0x3ff8030,0x3ff8030,0x30,0x0,0x30,0x0,0x0,0x0,0x30,0xf0,0x30,0x30,0x0,0x30,0x0,0x0,0x0,0xf0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xf0,0x0,0xf0,0x0,0x0,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_4() {
      jj_la1_4 = new int[] {0x0,0x0,0x1,0x2,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
